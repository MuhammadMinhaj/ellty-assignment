 ...
 * Defined root styles
 */
export const rootClasses = /*tw*/ 'relative';

/**
 * Defined label styles
 */
export const labelClasses =
  /*tw*/ 'absolute top-0 left-0 bg-white cursor-pointer w-[25px] h-[25px] flex items-center justify-center [&>*]:opacity-0 border-[1px] border-border-gray-main hover:border-border-gray-deep hover:text-border-gray-light hover:[&>*]:opacity-100';
